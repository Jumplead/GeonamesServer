...
module.exports = {
    jsonFromIpLookup: function(adminCodes, admin2Data, data, ip) {
        return this.formatResult(adminCodes, admin2Data, data);
    },
    formatResult: function (adminCodes, admin2Data, o) {
        var tab = {
            "score": o.score,
            ...
            "locality": (admin2Data ? admin2Data.name : null)
        };
    ...
    jsonFromQueryLookup: function(adminCodesResults, data) {
        var json = [], that = this;

        _.each(data, function(o, i) {
            json.push(that.formatResult(adminCodesResults[0], adminCodesResults[i+1], o));
        });

        return json;
    },
    jsonFromGeonameLookup: function(adminCodes, admin2Data, data) {
        var json = this.formatResult(adminCodes, admin2Data, data);
